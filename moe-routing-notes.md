...
Custom configs for this project's own numbers live under
`~/dev/astra-sim/examples/{network,system,workload}/.../moe_project/`,
analytical backend, congestion-unaware, 8-device EP group throughout.
